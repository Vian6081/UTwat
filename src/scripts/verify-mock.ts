...
async function main(){
 ...
 await page.getByRole('button',{name:'Create',exact:true}).click();await page.getByRole('button',{name:'Share',exact:true}).click();await page.locator('#message').filter({hasText:'Your post has been shared.'}).waitFor();
