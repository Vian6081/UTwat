...
readline.createInterface({input:process.stdin}).on('line',line=>{
 ...
 const allowed=m.method==='GET' && ['/canvas/sample.pdf','/dashboard/verification.css','/dashboard/verification.js','/canvas','/canvas/','/canvas/dashboard','/canvas/courses','/canvas/assignment','/canvas/presentation','/canvas/styles.css','/canvas/app.js','/canvas/state','/canvas/presentation/state','/canvas/file','/canvas/presentation/file','/api/photo','/dashboard/app.js','/dashboard/replay-data.js','/dashboard/fonts.css','/', '/health','/api/state','/api/runtime','/instagram','/instagram/','/instagram/state','/instagram/photo','/mock-instagram','/mock-instagram/','/mock-instagram/state','/mock-instagram/photo'].includes(m.path) || m.method==='POST' && ['/canvas/presentation/reset','/canvas/submit','/canvas/check','/canvas/presentation/submit','/canvas/presentation/check','/api/done','/instagram/share','/mock-instagram/share'].includes(m.path);
